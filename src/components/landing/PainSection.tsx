...
const painCards = [
  ...
  },
  {
    icon: DollarSign,
    title:
      "Enterprise tools start at $16k/year. For a small team, that's insane.",
...
const PainSection = () => {
  const ref = useFadeIn(() => trackSectionView("pain"));
      ...
      <div ref={ref} className="fade-in-section max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto bg-card border border-border rounded-lg p-8 text-center">
          <p className="text-muted-foreground italic leading-relaxed">
            Here's the truth: you're not missing these opportunities because
            you're lazy or disorganized.
            <br />
            <br />
            You're missing them because{" "}
            <span className="text-foreground font-medium">
              no tool was built for you.
            </span>{" "}
            The tools that solve this start at $16,000/year and require a
            dedicated GTM engineer to configure. The workarounds everyone
            recommends — Sales Nav, manual spreadsheets, Clay — all require
            someone to own the process full-time. You don't have that person. So
            warm leads go cold while your old champions build new companies with
